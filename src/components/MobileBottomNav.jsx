...
import { Bell, Calendar, Home, Repeat } from "lucide-react";
...
export default function MobileBottomNav({ unreadCount = 0 }) {
  ...
  return (
    <nav className="fixed inset-x-3 bottom-3 z-40 grid grid-cols-4 rounded-2xl border border-border bg-background/95 p-1 shadow-lg backdrop-blur-md lg:hidden" aria-label="ניווט ראשי">
