...
export default function ChangeRequestForm({ teacher, onSubmitted, onCancel }) {
  ...
  return (
    <div className="space-y-5 pt-2">
      ...
      <p className="text-xs text-muted-foreground">השינויים ייכנסו לתוקף וישפיעו על השיבוץ רק לאחר אישור מנהל המערכת.</p>
      <div className="flex gap-2">
        <Button className="flex-1 h-11" onClick={submit} disabled={saving}>{saving ? "שולח..." : "שלח לאישור מנהל"}</Button>
